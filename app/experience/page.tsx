  ...
  return (
    <div id="experience" className="w-[75%] md:w-[60%] z-[1] h-[calc(100vh_-_8rem_-_35px)] relative flex flex-col justify-center mx-auto">
      ...
      {experienceData.map((experience) => (
        <div key={experience.id} className='text-black text-[15px] py-4 w-full flex flex-col md:flex-row space-y-2 md:space-y-0'>
      ...
      {leadershipData.map((leadership) => (
        <div key={leadership.id} className='text-black text-[15px] py-4 w-full flex flex-col md:flex-row space-y-2 md:space-y-0'>
